...
class CorrespondenciasGController extends Controller
{
    ...
    public function create()
    {
        ...
        //$paises=Paise::all();
        return view('correspondencias.general.create', compact('codigosArchivo', 'tiposCorrespondencia', 'hoy', 'usuariosSolicita', 'usuariosRecibe', 'proyectos', 'consecutivo', 'entidades'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $correspondencia = $this->validate(request(),[
          ...
          //'usuarioRecibe_id'=>'requiered',
          'destinatario'=>'required',
          'entidadeDestinatario_id'=>'required',
          'detalle'=>'required'
        ]);
        ...
        $correspondencia->destinatario=$request->destinatario;
        $correspondencia->entidadeDestinatario_id=$request->entidadeDestinatario_id;
    ...
    public function edit($id)
    {
        ...
        return view("correspondencias.general.edit", compact('correspondencia', 'usuariosRecibe', 'usuariosSolicita', 'tiposCorrespondencia', 'entidades'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $correspondencia->update([
          'tipoCorrespondencia_id'=>$request->tipoCorrespondencia_id,
          'usuarioSolicita_id'=>$request->usuarioSolicita_id,
          'destinatario'=>$request->destinatario,
          'entidadeDestinatario_id'=>$request->entidadeDestinatario_id,
