...
@section("main")
  ...
  <div class="mx-auto" style="width:1200px;">
    <form method="post" action="/correspondencias/tesoreria">
      <div class="row">
      ...
      <div class="row">
        <div class="form-group col-sm-2">
          ...
          <input type="text" class="form-control" id="tipoPersona" name="tipoPersona" value="" disabled>
        </div>
        <div class="form-group col-sm-3">
          <label>Nit / CC</label>
          <input type="text" class="form-control" id="documento" name="documento" value="" disabled>
        </div>
        <div class="form-group col-sm-1">
          <label>DV</label>
          <input type="text" class="form-control" id="digito" name="digito" value="" disabled>
        </div>
        <div class="form-group col s3">
        ...
        <div class="form-group col-sm-2">
          <label>Index</label>
          <input type="text" class="form-control" name="#" placeholder="Index" disabled>
        </div>
      </div>
      <div class="row">
        <div class="form-group col s3">
        ...
        <div class="form-group col s3">
          ...
          <input type="datetime-local" class="form-control" name="fechaFactura" >
        </div>
      </div>
      <div class="row">
        <div class="form-group col s3 {{ $errors->has('valorFactura') ? 'has-error' : '' }}">
          <label>Valor Factura</label>
          <input type="text" class="form-control" name="valorFactura" placeholder="Valor Factura">
        ...
        <div class="form-group col s3 {{ $errors->has('valorIva') ? 'has-error' : '' }}">
          ...
          <input type="text" class="form-control" name="valorIva" placeholder="Valor Iva">
        ...
        <div class="form-group col s3 {{ $errors->has('valorImpoconsumo') ? 'has-error' : '' }}">
          ...
          <input type="text" class="form-control" name="valorImpoconsumo" placeholder="Valor Impoconsumo">
