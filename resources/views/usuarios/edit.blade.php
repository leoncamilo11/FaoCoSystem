    ...
    <form method="post" action="/usuarios/{{$usuario->id}}">
      <div class="row">
        <div class="form-group col s3 {{ $errors->has('name') ? 'has-error' : '' }}">
          <label>Nombres</label>
          <input type="text" class="form-control" name="nombre" placeholder="Nombres" value="{{$usuario->nombre}}">
        ...
        <div class="form-group col s3 {{ $errors->has('apellido') ? 'has-error' : '' }}">
          ...
          <input type="text" class="form-control" name="apellido" placeholder="Apellidos" value="{{$usuario->apellido}}">
        ...
        <div class="form-group col s3 {{ $errors->has('documento') ? 'has-error' : '' }}">
          ...
          <input type="text" class="form-control" name="documento" placeholder="Documento" value="{{$usuario->documento}}">
